...
for i, limits in enumerate(axis_limits):
    ...
    if limits[3] == 'solar_system_with_alpha_centauri':  
        ax.text(alpha_centauri_a[0] - 5000, alpha_centauri_a[1]+10000, 'Alpha Centauri A and B', fontsize=font_size, va='bottom', ha='center')
        ax.text(proxima_centauri[0] - 15000, proxima_centauri[1]-20000, 'Proxima Centauri', fontsize=font_size, va='bottom', ha='center')
